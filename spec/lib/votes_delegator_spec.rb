...
describe VotesDelegator do
  ...
  describe "the delegation process" do
    ...
    it "should assign a value to all the person who delegated their vote #1" do
      ...
      VotesDelegator.start_delegation(30, 85)
      DelegatedVote.count.should == init_count + 4
      DelegatedVote.all.inject({}){|hash, dv| hash[dv.user_id] = dv.value; hash }.should == {1 => 1.0, 2 => 1.0, 3=>1.0, 4=>1.0}
    end
  ...
  describe "the delegation process" do
    ...
    it "should assign a value to all the person who delegated their vote #3" do
      ...
      DelegatedVote.all.inject({}){|hash, dv| hash[dv.user_id] = dv.value; hash }.should == {1 => 1, 2 => 1, 5=>1.0, 3=>1.0, 4=>1.0}
    end
  ...
  describe "the delegation process" do
    ...
    it "should also work when there are negative values" do
      VotesDelegator.start_delegation(30, 85)
      DelegatedVote.count.should == 5
      DelegatedVote.all.inject({}){|hash, dv| hash[dv.user_id] = dv.value; hash }.should == {1 => -1, 2 => 1, 5=>-0.5, 3=>1.0, 4=>0.0}
    end
  ...
  describe "the delegation process" do
    ...
    it "should not assign any value since we're asking for a different proposal" do
      VotesDelegator.start_delegation(31, 85)
  ...
  describe "when a vote changes" do
    ...
    it "should assign a new value to all the person who delegated their vote" do
      ...
      VotesDelegator.update_delegation(30, 85, [@vote_changing])
      DelegatedVote.all.inject({}){|hash, dv| hash.merge({dv.user_id => dv.value }) }.should == {1 => 1, 2 => -1, 3 => -1, 4 => 0, 5 => 0.5}
    end
  ...
  describe "when a vote is added" do
    ...
    it "should assign a new value to all the person who delegated their vote" do
      ...
      VotesDelegator.update_delegation(30, 85, [new_vote])
      DelegatedVote.all.inject({}){|hash, dv| hash.merge({dv.user_id => dv.value }) }.should == {1 => 1, 2 => 1, 3 => -1, 4 => 0, 5 => 0.5}
    end
